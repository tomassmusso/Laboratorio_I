...
// las clases abstarctas son una representación de una idea/concepto
// las clases abstractas no me dejan instanciar variables de esa clase
// no toda clase abstracta tiene que tener métodos abstarctos
// no puedo tener métodos abstractos en una clase no abstracta
public abstract class Empleado implements Ivacacionar, Comparable<Empleado> {
    ...
    public abstract double cobrarSueldo() throws EmpleadosExceptions;
        // la clase abstarcta me permite solo declarar la asignatura de un metodo
